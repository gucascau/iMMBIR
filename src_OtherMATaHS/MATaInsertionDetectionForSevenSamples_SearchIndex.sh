...
SampleID1=JKM139-16d_S15
SampleID2=yYY517A1-16d_S3
SampleID3=yYY517A-16d_S5
SampleID4=yYY517A2-16d_S6
SampleID5=yYY517A-M-16d_S19

SampleID6=yYY517B-16d_S10
SampleID7=yYY517B-M-16d_S20
...
in=/project/RC_Cardio-Chen-e2/ch220812/Project/Insertion/CombinationChroAgeing/MATaInsertion/OtherTypes/WTD16
...
perl /project/RC_Cardio-Chen-e2/ch220812/Project/Insertion/CombinationChroAgeing/MATaInsertion/OtherTypes/scripts/MAT_detection_for_Seven_samples_SearchIndex.pl -i ${in}/ -m ${SampleID1} -n ${SampleID2} -p ${SampleID3} -q ${SampleID4} -f ${SampleID5} -a ${SampleID6} -b ${SampleID7} -o ${SampleID} -r ${String}
...
perl -ne '{chomp; my @array=split/\t/,$_; next if ($array[0] eq "MATsequence"); $n++;my $id=join ":",@array[1..9],$n; print ">$id\n$array[0]\n"}' ${SampleID}.MAT.txt >${SampleID}.MAT.fasta
...
perl /project/RC_Cardio-Chen-e2/ch220812/Project/Insertion/CombinationChroAgeing/MATaInsertion/OtherTypes/scripts/MAT_detection_for_deduplication_Seven_SearchIndex.pl -i ${SampleID}.MAT.sam -g ${SampleID}.MAT.fasta -o ${SampleID}.uniq -t ${SampleID}
