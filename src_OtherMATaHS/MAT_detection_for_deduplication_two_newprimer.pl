...
use Getopt::Long;
my %opts;
GetOptions(\%opts,"i:s","o:s","t:s","g:s","m:s","n:s","a:s","b:s");
print "*************\n*$version*\n*************\n";
if (!defined $opts{i} || !defined $opts{o} || !defined $opts{t}   || !defined $opts{g}  ) {
	...
	Usage: $0.pl 
				...
				-m The length of left primer
				-n The length of right primer
				-a The length of left MATa (+5bp)
				-b The length of right MATa (+5bp)
************************************************************************\n";
}
...
### the length of left and right Primer

my $LLPrim= (defined $opts{m})?$opts{m}:35;
my $LRPrim= (defined $opts{n})?$opts{n}:35;
### the length of left and right MATa

my $LLMAT= (defined $opts{a})?$opts{a}:45;
my $LRMAT= (defined $opts{b})?$opts{b}:45;
...
while (<I>){
	...
	### Left MAT side have two different deletions
		...
		}elsif (($1+$2+$3)>$LLPrim && ($1+$2+$3)<$LLMAT){
