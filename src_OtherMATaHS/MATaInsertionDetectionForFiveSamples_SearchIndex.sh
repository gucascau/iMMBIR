...
SampleID1=JKM139-3d_S1
SampleID2=yYY517A1-3d_S1
SampleID3=yYY517A2-3d_S4
SampleID4=yYY517A-3d_S3
SampleID5=yYY517B-3d_S8
...
in=/project/RC_Cardio-Chen-e2/ch220812/Project/Insertion/CombinationChroAgeing/MATaInsertion/OtherTypes/WTD3
...
mkdir ${SampleID}CombinedMATaB
cd ${in}/${SampleID}CombinedMATaB

perl /project/RC_Cardio-Chen-e2/ch220812/Project/Insertion/CombinationChroAgeing/MATaInsertion/OtherTypes/scripts/MAT_detection_for_five_samples_SearchIndex.pl -i ${in}/ -m ${SampleID1} -n ${SampleID2} -p ${SampleID3} -q ${SampleID4} -f ${SampleID5}  -o ${SampleID} -r ${String}
...
perl /project/RC_Cardio-Chen-e2/ch220812/Project/Insertion/CombinationChroAgeing/MATaInsertion/OtherTypes/scripts/MAT_detection_for_deduplication_Five_SearchIndex.pl -i ${SampleID}.MAT.sam -g ${SampleID}.MAT.fasta -o ${SampleID}.uniq -t ${SampleID}
