...
SampleID=Pol32_3_4BP

SampleID1=yYY387A_S1
SampleID2=yYY387B_S2
#SampleID3=JKM139-3_S4
#SampleID4=JKM139-4_S5

in=/project/RC_Cardio-Chen-e2/ch220812/Project/Insertion/CombinationWTRAD27DNA2/Sample_V0808/Pol32
...
perl /project/RC_Cardio-Chen-e2/ch220812/Project/Insertion/CombinationWTRAD27DNA2/Sample_V0808/Pol32/MAT_detection_for_two_samples_3_4bp.pl -i ${in}/ -m ${SampleID1} -n ${SampleID2}   -o ${SampleID}
...
perl /project/RC_Cardio-Chen-e2/ch220812/Project/Insertion/CombinationWTRAD27DNA2/Sample_V0808/Pol32/MAT_detection_for_deduplication_two_2bp_v3.pl -i ${SampleID}.MAT.sam -g ${SampleID}.MAT.fasta -o ${SampleID}.uniq -t ${SampleID}
