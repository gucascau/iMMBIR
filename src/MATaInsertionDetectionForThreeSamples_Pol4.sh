...
SampleID1=yYY359-0min_S2
SampleID2=yYY359-20min_S4
SampleID3=yYY359-40min_S6
#SampleID4=JKM139-4_S5


in=/lab-share/Cardio-Chen-e2/Public/xwang/tmhxxw9/tmhxxw9/project/Yangy-Yu_miseqyeast_03012020/Alignment_1/20200301_222204/Fastq/Update_V210924
...
perl ${softpath}/iMMBIR/src/MAT_detection_for_three_samples_v2.pl -i ${in}/ -m ${SampleID1} -n ${SampleID2} -p ${SampleID3}  -o ${SampleID}
...
perl ${softpath}/iMMBIR/src/MAT_detection_for_deduplication_three.pl  -i ${SampleID}.MAT.sam -g ${SampleID}.MAT.fasta -o ${SampleID}.uniq -t ${SampleID}
