...
SampleID1=yYY497-1_S17
SampleID2=yYY497-2_S18
#SampleID3=JKM139-3_S4
#SampleID4=JKM139-4_S5


in=/lab-share/Cardio-Chen-e2/Public/xwang/tmhxxw9/tmhxxw9/project/Mutants_V1224/Yang-Yu_Miseqyeast_120232019/20191215_220409/Fastq/Update_V210924
...
perl ${softpath}/iMMBIR/src/MAT_detection_for_two_samples_v2.pl -i ${in}/ -m ${SampleID1} -n ${SampleID2}   -o ${SampleID}
...
perl ${softpath}/iMMBIR/src/MAT_detection_for_deduplication_two.pl  -i ${SampleID}.MAT.sam -g ${SampleID}.MAT.fasta -o ${SampleID}.uniq -t ${SampleID}
