...
SampleID=yYY249A_S16

in=/project/RC_Cardio-Chen-e2/ch220812/Project/Insertion/20200817_010337_DNA2Derivate/Update_V210924/
...
perl ${softpath}/iMMBIR/src/MAT_detection_for_deduplication_one.pl -i ${SampleID}.MAT.sam -g ${SampleID}.MAT.fasta -o ${SampleID}.uniq -t ${SampleID}
